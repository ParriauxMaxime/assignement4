...
namespace Assignment4.PartII.Tests
{
    public class DataServiceTests
    {
        /* Categories */
        // Added in PartII
        // NOTE: This file uses ascii charset while the other test uses utf-8 charset for some reason
        // We fail two tests because of this but actually the code is working
        // We converted ? chars to their actual values because of this issue
        // Also sql file has actually 11 categories instead of 8, read the note below for details
        ...
        public void GetAllCategories_NoArgument_ReturnsAllCategories()
        {
            ...
            Assert.Equal(8, categories.Count); // <-- Note that this sql file given in moodle has 11 categories
            // with the last 3 of them being
            // (11,'Testing','Testing'),(12,'Testing','Testing'),(13,'Testing','Testing')
            // That means the sql file is erroneous
            //
        ...
        public void GetProduct_NameSubString_ReturnsProductsThatMachesTheSubString()
        {
            ...
            // Assert.Equal("Guaran? Fant?stica", products.Last().ProductName);
